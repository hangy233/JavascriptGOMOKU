    ...
    render: function() {
        return (
            ...
            React.createElement("div", {id: "AIOption"}, 
                React.createElement("div", {id: "standard", onClick: this.props.newGame.bind(this,"standard")}, "BLACK"), 
                React.createElement("div", {id: "freestyle", onClick: this.props.newGame.bind(this,"freestyle")}, "WHITE")
            )
