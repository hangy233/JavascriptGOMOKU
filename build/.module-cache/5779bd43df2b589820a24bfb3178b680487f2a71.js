 ...
 var Board = React.createClass({displayName: "Board",
            ...
            setAI: function(AIColor){
              ...
              this.setState({
               ...
               this.AIPutChess(tempAIColor);
            },
            
            AIPutChess: function(tempAIColor) {
                    ...
                    for(var j = 0; j< this.props.size ; j++){
                        ...
                        nodes.push( 
                            React.createElement("div", {className: color}, 
                        	  	...
                        	  	React.createElement("label", {htmlFor: index, onClick: this.humanPutChess.bind(this,[i,j])})
                          	)
              	        );
