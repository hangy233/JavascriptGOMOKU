 ...
 var Board = React.createClass({displayName: "Board",
            ...
            putChess: function(key) {
                if(!this.state.endGame){
                    ...
                    if(gomoku.gameWin(key[0], key[1], this.state.units(key[0], key[1]).color)){
                        this.setState({
                            endGame:true,
                            showAIOption: false,
                            showRuleOption: false,
                        ...
                        this.putChess([gomoku.AIMove(true).i, gomoku.AIMove(true).j]);
                    }
                    else if(this.state.AI === "white" && this.state.units[key[0]][key[1]].firstHand){
                        this.putChess([gomoku.AIMove(false).i, gomoku.AIMove(false).j]);
                    }
                }
            },
