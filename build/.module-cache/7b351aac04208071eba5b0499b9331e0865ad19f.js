 ...
 var Board = React.createClass({displayName: "Board",
            ...
            putChess: function(key) {
                if(!this.state.endGame){
                    ...
                    else if(this.state.AI === "black" && !this.state.units[key[0]][key[1]]){
                        putChess(gomoku.AIMove(true).i, gomoku.AIMove(true).j);
                        alert("sa");
                    }
                    else if(this.state.AI === "white" && this.state.units[key[0]][key[1]]){
                        putChess(gomoku.AIMove(false).i, gomoku.AIMove(false).j);
                    }
                }
            },
